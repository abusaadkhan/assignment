  ...
  return (
    ...
    {openModal? (
      <div onClick={()=>setOpenModal(false)} >
        <h1>hello</h1>
        <div dangerouslySetInnerHTML={{__html:"<iframe height='400' width='60%' scrolling='no' frameborder='no' allowtransparency='true' allowfullscreen='true' src='https://seths.blog/'  />"}} />
      </div>
    ) : (
      <div>
